...
if (window.location.href.indexOf("search") < 0 && window.location.href.indexOf("emd") < 0 && window.location.href.indexOf("index") < 0) {
    setInterval(function () {
