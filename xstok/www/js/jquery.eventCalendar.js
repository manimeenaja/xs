                                ...
                                if (err == 0) {
                                    if (event.title) {
                                        ...
                                        if (event.room == 'N') {
                                            ...
                                            heart = '<div class="heart" id="heart' + event.lot_id + '' + event.room_id + '" onclick="heart(\'' + event.lot_id + '\',\'' + event.room_id + '\',\'' + event.auc_type_id + '\')" auc-type-id="' + event.auc_type_id + '" lot-id="' + event.lot_id + '" room-id="' + event.room_id + '"><i class="fa fa-heart ' + selected + '"></i></div>';
                                        }

                                        events.push('<li id="' + key + '" class="' + event.type + '">' + eventTitle + heart + '<p class="eventDesc ' + eventDescClass + '">' + event.description + '</p></li>');
                                    }
                                    i++;
                                    title_tmp.push(event.title);
                                }
                            }
                        }
                    }
