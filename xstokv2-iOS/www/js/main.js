...
if (localStorage.logged_in == '1') {
    setInterval(function () {
        if (window.location.href.indexOf("filter") < 0 && window.location.href.indexOf("register") < 0 && window.location.href.indexOf("search") < 0 && window.location.href.indexOf("otp") < 0 && window.location.href.indexOf("kyc_single") < 0) {
    ...
    setInterval(function () {
        if (window.location.href.indexOf("filter") < 0 && window.location.href.indexOf("register") < 0) {
